...
('chuqur-diqqat','Diqqatni jamlash san''ati: chuqur ish holatiga kirish','talim','Chalg''ituvchi dunyoda e''tibor eng qimmatli resursga aylandi.','Diqqat — cheklangan resurs. Har bir uzilishdan keyin miyaga avvalgi kontekstga qaytish uchun o''rtacha 15-20 daqiqa kerak bo''ladi.

Chuqur ish uchun uchta shart yetarli: aniq boshlanish vaqti, bitta vazifa va tashqi signallarning yo''qligi.

Kuniga 90 daqiqalik ikkita chuqur blok — sakkiz soatlik uzilib-uzilib ishlashdan ko''ra ko''proq natija beradi.','/article-sleep.jpg','9 daqiqa', now() - interval '4 day'),
('qaror-qabul-qilish','Nima uchun biz o''zimizga zararli qarorlar qabul qilamiz?','qarorlar','Kognitiv xatoliklar va ularning hayot sifatiga uzoq muddatli ta''siri.','Qaror qabul qilish paytida miya ikki tizim o''rtasida ishlaydi: tez, avtomatik va sekin, tahliliy. Charchoq va stress birinchisining ta''sirini kuchaytiradi.

Eng keng tarqalgan xatoliklar — hozirgi lazzatni ustun qo''yish, tasdiqlash tarafkashligi va yo''qotishdan qo''rquv.

Yechim: muhim qarorlarni ertalabki soatlarga ko''chiring, mezonlarni oldindan yozing va qaror sabablarini qayd etib boring.','/article-eq.jpg','10 daqiqa', now() - interval '5 day'),
('shaxsiy-rivojlanish-maqsad','Maqsad qo''yishning beshta ilmiy usuli','rivojlanish','Dopaminning roli va motivatsiyani uzoq muddat saqlash bo''yicha amaliy tavsiyalar.','Motivatsiya natijadan emas, jarayondagi kichik yutuqlardan oziqlanadi. Dopamin ko''proq kutish bosqichida ajraladi.

Shuning uchun katta maqsadni o''lchanadigan haftalik qadamlarga bo''lish shart. Har bir qadam — kichik mukofot signali.

Maqsadni yozib qo''ying, uni kimgadir ayting va haftalik qayta ko''rib chiqish odatini yarating.','/article-habits.jpg','5 daqiqa', now() - interval '6 day');